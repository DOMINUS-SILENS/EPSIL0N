...
class ContactGroupeClientProjector extends Projector
{
    protected string $table = 'contact_groupe_client';
    ...
    public function handleContactGroupeClientCreated(array $payload, DomainOutbox $event): void
    {
        // Implement Idempotent UPSERT logic for contact_groupe_client
    }

    public function handleContactGroupeClientUpdated(array $payload, DomainOutbox $event): void
    {
        // Implement Idempotent UPSERT logic for contact_groupe_client
    }
}
