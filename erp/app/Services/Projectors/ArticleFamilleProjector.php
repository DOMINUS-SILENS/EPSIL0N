...
class ArticleFamilleProjector extends Projector
{
    protected string $table = 'article_famille';
    ...
    public function handleArticleFamilleCreated(array $payload, DomainOutbox $event): void
    {
        // Implement Idempotent UPSERT logic for article_famille
    }

    public function handleArticleFamilleUpdated(array $payload, DomainOutbox $event): void
    {
        // Implement Idempotent UPSERT logic for article_famille
    }
}
