...
class TaxeProjector extends Projector
{
    ...
    public function handleTaxeCreated(array $payload, DomainOutbox $event): void
    {
        // Implement Idempotent UPSERT logic for taxes
    }

    public function handleTaxeUpdated(array $payload, DomainOutbox $event): void
    {
        // Implement Idempotent UPSERT logic for taxes
    }
}
