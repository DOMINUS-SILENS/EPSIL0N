...
final class CustomerRenamed extends DomainEventContract
{
     ...
     */
    public static function forTest(string $aggregateId, string $newName): self
    {
        return new self(
            EventId::fromString('00000000-0000-0000-0000-000000000002'),
