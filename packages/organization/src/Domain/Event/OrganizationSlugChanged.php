...
/**
 * Event raised when an organization's slug is changed.
 */
final class OrganizationSlugChanged implements DomainEvent
{
    ...
    public function __construct(
        ...
        private readonly TenantSlug $oldSlug,
        private readonly TenantSlug $newSlug
    ) {
    }
    ...
    {
        return 'Organization.SlugChanged';
    }
    ...
    public function getOldSlug(): TenantSlug
    {
        return $this->oldSlug;
    }

    public function getNewSlug(): TenantSlug
    {
        return $this->newSlug;
    }
    ...
    public static function fromStorage(array $payload, \Spiral\Kernel\Domain\Shared\Event\EventMetadata $metadata): self
    {
        return new self(
            ...
            oldSlug: TenantSlug::fromString((string) $payload['oldSlug']),
            newSlug: TenantSlug::fromString((string) $payload['newSlug'])
        );
    }
}
