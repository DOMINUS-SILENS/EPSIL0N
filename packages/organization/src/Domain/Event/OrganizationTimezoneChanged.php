...
/**
 * Event raised when an organization's timezone is changed.
 */
final class OrganizationTimezoneChanged implements DomainEvent
{
    ...
    public function __construct(
        ...
        private readonly TimezoneId $oldTimezone,
        private readonly TimezoneId $newTimezone
    ) {
    }
    ...
    {
        return 'Organization.TimezoneChanged';
    }
    ...
    public function getOldTimezone(): TimezoneId
    {
        return $this->oldTimezone;
    }

    public function getNewTimezone(): TimezoneId
    {
    ...
    public function toArray(): array
    {
        return [
            ...
            'oldTimezone' => (string) $this->oldTimezone,
            'newTimezone' => (string) $this->newTimezone,
        ];
    }
    ...
    public static function fromStorage(array $payload, \Spiral\Kernel\Domain\Shared\Event\EventMetadata $metadata): self
    {
        return new self(
            ...
            oldTimezone: TimezoneId::fromString((string) $payload['oldTimezone']),
            newTimezone: TimezoneId::fromString((string) $payload['newTimezone'])
        );
    }
}
